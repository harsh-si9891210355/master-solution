...
class User(Base):
    ...
    first_name_es: Mapped[str] = mapped_column(String(255), nullable=False)
    first_name_fr: Mapped[str] = mapped_column(String(255), nullable=False)
    last_name_en: Mapped[str] = mapped_column(String(255), nullable=False)
    last_name_es: Mapped[str] = mapped_column(String(255), nullable=False)
    last_name_fr: Mapped[str] = mapped_column(String(255), nullable=False)
