...
class User(Base):
    ...
    first_name_es: Mapped[str | None] = mapped_column(String(255), nullable=True)
    first_name_fr: Mapped[str | None] = mapped_column(String(255), nullable=True)
    last_name_en: Mapped[str] = mapped_column(String(255), nullable=False)
    last_name_es: Mapped[str | None] = mapped_column(String(255), nullable=True)
    last_name_fr: Mapped[str | None] = mapped_column(String(255), nullable=True)
